...
This document tracks feature parity across thirteen implementations of the personal AI assistant architecture. OpenClaw (TypeScript) is the reference implementation; IronClaw, LocalGPT, Moltis, and ZeroClaw are Rust implementations; Nanobot and CoPaw are Python implementations; PicoClaw is Go; NullClaw is Zig; MimiClaw and ZClaw are C (ESP32); RosClaw is a TypeScript OpenClaw plugin for ROS2 robotics; TinyClaw is a TypeScript multi-agent orchestrator.
...
| **RosClaw** | TypeScript + Python | Apache 2.0 | https://github.com/PlaiPin/rosclaw |
| **ZClaw** | C (ESP32) | MIT | https://github.com/tnm/zclaw |
| **TinyClaw** | TypeScript | MIT | https://github.com/TinyAGI/tinyclaw |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|-------|
| Hub-and-spoke architecture | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ❌ | ✅ | MimiClaw/ZClaw: embedded; RosClaw: OpenClaw plugin |
| WebSocket control plane | ✅ | ✅ | 🚧 | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | RosClaw: rosbridge WebSocket |
| Single-user system | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | |
| Multi-agent routing | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | TinyClaw: multi-agent teams |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|-------|
| Gateway control plane | ✅ | ✅ | ✅ | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | TinyClaw: Hono HTTP |
| HTTP endpoints for Control UI | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | TinyClaw: TinyOffice |
...
| Agent event broadcast | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | TinyClaw: SSE |
| Channel health monitor | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | |
| Presence system | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Trusted-proxy auth mode | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| APNs push pipeline | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Oversized payload guard | ✅ | 🚧 | ✅ | 🚧 | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Pre-prompt context diagnostics | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | RosClaw: robot context injection |
...
| Channel | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Priority | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|----------|-------|
| CLI/TUI | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ✅ | ✅ | - | ZClaw: serial; TinyClaw: tinyclaw send |
| HTTP webhook | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | 🚧 | ✅ | - | ZClaw: web relay |
| REPL (simple) | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ❌ | ❌ | - | |
...
| Command | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Priority | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|----------|-------|
| `run` (agent) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | - | MimiClaw: always-on embedded; ZClaw: always-on |
...
| `logs` | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | P3 | |
| `update` | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ✅ | ❌ | P3 | MimiClaw: OTA updates; ZClaw: OTA |
| `completion` | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | P3 | |
| `/subagents spawn` | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | P3 | |
| `/export-session` | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | P3 | |
...
| Multi-provider failover | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ✅ | MimiClaw: Anthropic + OpenAI switchable; RosClaw: via OpenClaw |
| Per-sender sessions | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ✅ | RosClaw: via OpenClaw |
| Global sessions | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Session pruning | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | |
| Context compaction | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ❌ | RosClaw: via OpenClaw |
| Post-compaction read audit | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Post-compaction context injection | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Custom system prompts | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ✅ | RosClaw: via OpenClaw |
| Skills (modular capabilities) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ➖ | ✅ | ✅ | MimiClaw: on-device skills; RosClaw: via OpenClaw |
...
| Z.AI tool_stream | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Plugin tools | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ✅ | All: MCP tools; IronClaw: WASM; RosClaw: ROS2 tools |
| Tool policies (allow/deny) | ✅ | ✅ | ✅ | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | RosClaw: safety policies |
| Exec approvals (`/approve`) | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | |
| Elevated mode | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
| Subagent support | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | TinyClaw: multi-agent teams |
...
| Provider | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Priority | Notes |
|----------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|----------|-------|
| NEAR AI | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ➖ | ❌ | ❌ | - | RosClaw: via OpenClaw |
| Anthropic (Claude) | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ✅ | - | RosClaw: via OpenClaw; TinyClaw: Claude CLI |
| OpenAI | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ➖ | ✅ | ✅ | - | RosClaw: via OpenClaw; TinyClaw: Codex CLI |
| AWS Bedrock | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ➖ | ❌ | ❌ | P3 | |
| Google Gemini | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ❌ | ❌ | P3 | |
| NVIDIA API | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ➖ | ❌ | ❌ | P3 | |
| OpenRouter | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ✅ | ❌ | - | |
| Tinfoil | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ➖ | ❌ | ❌ | - | IronClaw-only |
| OpenAI-compatible | ❌ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ❌ | ✅ | - | TinyClaw: custom providers |
| Ollama (local) | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ✅ | ❌ | - | |
| Perplexity | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ➖ | ❌ | ❌ | P3 | |
| MiniMax | ✅ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ➖ | ❌ | ❌ | P3 | |
| GLM-5 | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ❌ | ➖ | ❌ | ❌ | P3 | |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Priority | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|----------|-------|
| Image processing (Sharp) | ✅ | ❌ | 🚧 | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ❌ | 🚧 | ❌ | 🚧 | P2 | RosClaw: camera snapshot; TinyClaw: image processing |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|-------|
| Primary config file | ✅ `openclaw.json` | ✅ `.env` | ✅ `config.toml` | ✅ `moltis.toml` | ✅ `config.json` | ✅ `config.yaml` | ✅ `config.yaml` | ✅ `config.toml` | ✅ `config.json` | ❌ | ❌ | ✅ NVS | ✅ `settings.json` | |
| JSON5 support | ✅ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | |
| YAML alternative | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | |
...
| State directory | ✅ `~/.openclaw-state/` | ✅ `~/.ironclaw/` | ✅ `~/.localgpt/` | ✅ `~/.moltis/` | ✅ `~/.nanobot/` | ✅ `~/.copaw/` | ✅ `~/.picoclaw/` | ✅ `~/.zeroclaw/` | ✅ `~/.nullclaw/` | ❌ | ❌ | ✅ NVS flash | ✅ `~/.tinyclaw/` | |
| Credentials directory | ✅ | ✅ | ✅ | ✅ | 🚧 | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ NVS | ✅ | ZeroClaw: encrypted with chacha20poly1305 |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|-------|
| Vector memory | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ✅ | ✅ | ❌ | ➖ | ❌ | ❌ | RosClaw: via OpenClaw |
| Session-based memory | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ✅ | ✅ | RosClaw: via OpenClaw |
...
| Memory store/recall/forget tools | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ | ❌ | ➖ | ✅ | ❌ | RosClaw: via OpenClaw |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Priority | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|----------|-------|
| Control UI Dashboard | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | - | CoPaw: Console web UI; TinyClaw: TinyOffice |
| Channel status view | ✅ | 🚧 | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | - | |
| Agent management | ✅ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | P3 | |
| Model selection | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | - | |
| Config editing | ✅ | ❌ | ❌ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | P3 | |
...
| Leak detection | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ZClaw: key redaction |
...
| Encrypted secrets storage | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ZeroClaw/NullClaw: chacha20poly1305 AEAD; ZClaw: NVS encryption |
...
| Feature | OpenClaw | IronClaw | LocalGPT | Moltis | Nanobot | CoPaw | PicoClaw | ZeroClaw | NullClaw | MimiClaw | RosClaw | ZClaw | TinyClaw | Notes |
|---------|----------|----------|----------|--------|---------|-------|----------|----------|----------|----------|---------|-------|----------|-------|
| Primary language | TypeScript | Rust | Rust | Rust | Python | Python | Go | Rust | Zig | C (ESP-IDF) | TypeScript | C (ESP-IDF) | TypeScript | |
| Build tool | tsdown | cargo | cargo | cargo | pip/uv | pip/uv | go build | cargo | zig build | idf.py | pnpm | idf.py | pnpm | |
...
| Package manager | pnpm | cargo | cargo | cargo | pip/uv | pip/uv | go mod | cargo | zig | ESP-IDF | pnpm | ESP-IDF | pnpm | |
| Test framework | Vitest | built-in | built-in | built-in | ❌ | pytest | built-in | built-in | built-in | ❌ | Vitest | ❌ | ❌ | ZClaw: host tests only |
...
| Homebrew package | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | |
| Binary size (release) | ~28 MB | ~44 MB | ~15 MB | ~large | N/A | N/A | ~8 MB | ~3.4 MB | ~678 KB | ~firmware | ~28 MB | ~firmware | N/A | RosClaw: via OpenClaw |
| RAM footprint | &gt;1 GB | ~large | ~moderate | ~large | &gt;100 MB | ~moderate | &lt;10 MB | &lt;5 MB | ~1 MB | ~512 KB | &gt;1 GB | ~512 KB | &gt;100 MB | RosClaw/ZClaw: via OpenClaw/ESP32 |
| Startup time (0.8 GHz) | &gt;500 s | ~fast | ~fast | ~fast | &gt;30 s | ~fast | &lt;1 s | &lt;10 ms | &lt;8 ms | instant | &gt;500 s | instant | &gt;5 s | RosClaw: via OpenClaw |
| Power consumption | ~100 W | ~moderate | ~moderate | ~moderate | ~moderate | ~moderate | &lt;5 W | &lt;5 W | &lt;1 W | 0.5 W | ~100 W | 0.5 W | ~moderate | RosClaw: via OpenClaw |
| Target hardware | Mac/PC | Mac/PC | Mac/PC | Mac/PC | Linux SBC | Mac/PC | $10 board | $10 board | $5 board | $5 ESP32-S3 | Mac/PC | $5 ESP32 | Mac/PC | |
